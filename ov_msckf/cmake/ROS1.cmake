...
find_package(catkin QUIET COMPONENTS roscpp rosbag tf std_msgs geometry_msgs sensor_msgs nav_msgs visualization_msgs image_transport cv_bridge ov_core ov_init depthai_standalone depthai_bridge depthai_ros_msgs)
...
if (catkin_FOUND AND ENABLE_ROS)
    ...
    catkin_package(
            CATKIN_DEPENDS roscpp rosbag tf std_msgs geometry_msgs sensor_msgs nav_msgs visualization_msgs image_transport cv_bridge ov_core ov_init depthai_standalone depthai_bridge depthai_ros_msgs
            INCLUDE_DIRS src/
...
include_directories(
        src
        ../../../depthai_standalone/include/depthai_standalone
        ${EIGEN3_INCLUDE_DIR}
        ${Boost_INCLUDE_DIRS}
        ${CERES_INCLUDE_DIRS}
        ${catkin_INCLUDE_DIRS}
